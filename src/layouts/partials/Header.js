                        ...
                        <div id="kt_header_menu" className="header-menu header-menu-mobile header-menu-layout-default">
                            ...
                            <ul className="menu-nav">
                                <li className="menu-item menu-item-submenu" data-menu-toggle="click" aria-haspopup={true}>
                                    <Link to="/empty" className="menu-link menu-toggle">
                                        <span className="menu-text">Features</span>
                                        <i className="menu-arrow" />
                                    </Link>
                                    <div className="menu-submenu menu-submenu-fixed menu-submenu-left" style={{ width: 1000 }}>
                                                ...
                                                <li className="menu-item">
                                                    ...
                                                    <ul className="menu-inner">
                                                        <li className="menu-item" aria-haspopup={true}>
                                                            <Link to="/empty" className="menu-link">
                                    ...
                                    <div className="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style={{ backgroundImage: 'url(/assets/media/misc/bg-1.jpg)' }}>
                                        ...
                                        <ul className="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8" role="tablist">
                                            <li className="nav-item">
                                                <Link to="/empty" className="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications">Alerts</Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link to="/empty" className="nav-link" data-toggle="tab" href="#topbar_notifications_events">Events</Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link to="/empty" className="nav-link" data-toggle="tab" href="#topbar_notifications_logs">Logs</Link>
                                            </li>
                                        </ul>
                                        {/*end::Tabs*/}
                                    </div>
                                    ...
                                    <div className="tab-content">
                                        ...
                                        <div className="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                                            ...
                                            <div className="scroll pr-7 mr-n7" data-scroll="true" data-height={300} data-mobile-height={200}>
                                                ...
                                                <div className="d-flex align-items-center mb-6">
                                                    ...
                                                    <div className="d-flex flex-column font-weight-bold">
                                                        <Link to="/empty" className="text-dark text-hover-primary mb-1 font-size-lg">Cool App</Link>
                                                ...
                                                <div className="d-flex align-items-center mb-6">
                                                    ...
                                                    {/*begin::Text*/}
                                                    <div className="d-flex flex-column font-weight-bold">
                                                        <Link to="/empty" className="text-dark-75 text-hover-primary mb-1 font-size-lg">Awesome SAAS</Link>
                                                ...
                                                <div className="d-flex align-items-center mb-6">
                                                    ...
                                                    {/*begin::Text*/}
                                                    <div className="d-flex flex-column font-weight-bold">
                                                        <Link to="/empty" className="text-dark text-hover-primary mb-1 font-size-lg">Claudy Sys</Link>
                                                ...
                                                <div className="d-flex align-items-center mb-6">
                                                    ...
                                                    {/*begin::Text*/}
                                                    <div className="d-flex flex-column font-weight-bold">
                                                        <Link to="/empty" className="text-dark text-hover-primary mb-1 font-size-lg">Trilo Service</Link>
                                                ...
                                                <div className="d-flex align-items-center mb-6">
                                                    ...
                                                    {/*begin::Text*/}
                                                    <div className="d-flex flex-column font-weight-bold">
                                                        <Link to="/empty" className="text-dark text-hover-primary mb-1 font-size-lg">Bravia SAAS</Link>
                                                ...
                                                <div className="d-flex align-items-center mb-6">
                                                    ...
                                                    {/*begin::Text*/}
                                                    <div className="d-flex flex-column font-weight-bold">
                                                        <Link to="/empty" className="text-dark text-hover-primary mb-1 font-size-lg">Express Wind</Link>
                                                ...
                                                <div className="d-flex align-items-center mb-6">
                                                    ...
                                                    {/*begin::Text*/}
                                                    <div className="d-flex flex-column font-weight-bold">
                                                        <Link to="/empty" className="text-dark text-hover-primary mb-1 font-size-lg">Bruk Fitness</Link>
                                            ...
                                            <div className="d-flex flex-center pt-7">
                                                <Link to="/empty" className="btn btn-light-primary font-weight-bold text-center">See All</Link>
                                            </div>
                                            {/*end::Action*/}
                                        </div>
                                        {/*end::Tabpane*/}

...
import { SocketIO, socket, AuthUser } from '../store';

function Dashboard() {
    const getSocketIO = useRecoilValue(SocketIO);
                ...
                <div className="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
                    <div className="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                        ...
                        <div className="d-flex align-items-center">
                            <button onClick={onDisconnect} className="btn btn-light-primary font-weight-bolder btn-sm">Actions</button>
                        </div>
                    </div>
                </div>
